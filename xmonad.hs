...
import System.IO
import Control.Arrow ((***), second) -- also for Flip
...
-- Adapted from https://github.com/jonhoo/configs/blob/master/gui/.xmonad/xmonad.hs
...
myWorkspaces    = ["web","web2","a","b","c","d","e","music","daemon"]

myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    [ ((mod4Mask, xK_f), (spawn "firefox --private"))
    , ((mod4Mask, xK_p), (spawn "rofi -show run"))
    , ((mod4Mask, xK_BackSpace), (spawn "xsecurelock"))
...
myLayout = onWorkspace "web" leftTiled tiled ||| (Mirror tiled) ||| Full ||| PiP
  where
...
main = do
    xmonad $ desktopConfig {
        ...
        layoutHook         = desktopLayoutModifiers $ noBorders $ spacingWithEdge 15 $ myLayout,
